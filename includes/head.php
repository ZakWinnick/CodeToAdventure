<head>
    <!-- Basic meta tags for character encoding and responsive behavior -->
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    
    <!-- Primary Meta Tags - These define how your site appears in search results -->
    ...
    <!-- Open Graph Meta Tags - These control how your site appears when shared on Facebook -->
    ...
    <!-- Dark mode initialization - Must come before Tailwind -->
    <script>
